...
Get-Date -Format "yyyy-MM-dd HH:mm"
     ...
     Write-Host " Step 3 - Part 1: Start $VmMachine Before configuration.."         -ForegroundColor Yellow
...
Try 
    { # Start Try Confirmation
     ...
     Write-Host "  Step 3 - Part 1: Start $VmMachine Before configuration... "      -ForegroundColor Green
