...
Get-Date -Format "yyyy-MM-dd HH:mm"
     ...
     Write-Host "       Step 5: Configure $VmMachine...  "                          -ForegroundColor Yellow
...
Try 
    { # Start Try change Ip-adress and rename computer
     ...
     # Change Nic Settings
      Get-NetAdapter | 
      New-NetIPAddress -AddressFamily IPv4 "10.10.10.30" –PrefixLength 24 -DefaultGateway "10.10.10.2" |
      Set-DnsClientServerAddress -ServerAddresses ("10.10.10.2","10.10.10.3")  |
      Set-NetIPInterface -Dhcp Disabled   
     # Rename Computer
     Rename-Computer -NewName MsSql01 -Force | Shutdown -r } # End ScriptBlock
...
Try 
    { # Start Try Confirmation
     ...
     Write-Host "         Step 5 - Part 2: Configure $VmMachine ...       "          -ForegroundColor Green
